    ...
    IRewardsVault
{
    ...
    struct UserInfo {
        ...
        uint256 rewardBalance; // user's reward
    }
    ...
    uint256 private accountedBalance; // tracking of accounted balance
    ...
    /**
     * @dev Allows to join the rewards vault when user staked, only called by LynxDirectStaking Contract.
     * @param claimaddr The address of the user joining the vault.
    ...
    /**
     * @dev Allows to leave the rewards vault when exit staking, only called by LynxDirectStaking Contract.
     * @param claimaddr The address of the user leaving the vault.
    ...
    /**
     * @dev Allows a user to claim rewards from the rewards vault.
    ...
    /**
     * @dev Calculates the pending reward for the manager and the vault.
     * @return managerR The pending reward for the manager.
     * @return vaultR The pending reward for the vault.
     */
    ...
    /**
     * @dev Emitted when an address joins the vault by depositing funds.
    ...
    /**
     * @dev Emitted when an address leaves the vault by withdrawing funds.
     * @param claimaddr The address of the user who left the vault.
    ...
    /**
     * @dev Emitted when the manager withdraws their fee from the vault.
